...
def build_mvn_project(project_working_dir):
    cmd = f'cd {project_working_dir} && mvn install -Dmaven.test.skip -Dcheckstyle.skip=true -Dlicense.skipAddThirdParty=true -Drat.skip=true -Dmaven.javadoc.skip=true'
