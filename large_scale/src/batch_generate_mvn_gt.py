# batch generate groundtruth by deptxt and classpath txt
import csv
import os
import shutil
...
report_status_path = "/home/lida/SCAEvaluation-main/large_scale/manifest/gt_gen_status.json"
    ...
    try: 
        for idx, row in enumerate(csv_reader):
            ...
            if build_cp_ok and dep_ok:
                ...
                project_report_path = os.path.join(report_path, local_name, "groundtruth")
                os.makedirs(project_report_path, exist_ok=True)
                generate_gt_ok = generate_mvn_dep_tree_gt(dep_tree_txt, build_classpath_txt, project_report_path, local_name)
            else:
