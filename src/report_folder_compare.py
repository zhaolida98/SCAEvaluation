...
def generate_sca_tools_report(working_dir: str, project_name=""):
    for comparator in comparator_list:
        for comparatee in comparatee_list:
            ...
            comparator_component_report = os.path.join(working_dir, f"{comparator}-component-{test_case}.csv")
            comparator_issue_report = os.path.join(working_dir, f"{comparator}-issue-{test_case}.csv")
            comparatee_component_report = os.path.join(working_dir, f"{comparatee}-component-{test_case}.csv")
            comparatee_issue_report = os.path.join(working_dir, f"{comparatee}-issue-{test_case}.csv")
            ...
            testsuite_report_summary_path = os.path.join(working_dir, f"{comparator}-{comparatee}-summary.json")
